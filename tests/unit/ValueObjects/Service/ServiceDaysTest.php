...
class ServiceDaysTest extends TestCase
{
    ...
    {
        // Given
        $mock = Mockery::mock('App\PRS\Classes\ValueObjects\ServiceDays[asArray]', array(0));
    ...
    {
        // Given
        $mock = Mockery::mock('App\PRS\Classes\ValueObjects\ServiceDays[shortNames]', array(0));

...
class ReadingTest extends TestCase
{
    ...
    {
        // Given
        $tagMock = Mockery::mock('App\PRS\Classes\ValueObjects\Administrator\Tag');
    ...
    public function get_styled_reading_html_span()
    {
        // Given
        $tagMock = Mockery::mock('App\PRS\Classes\ValueObjects\Administrator\Tag');
        $readingMock = Mockery::mock('App\PRS\Classes\ValueObjects\Report\Reading[class,toString]', [0, $tagMock]);

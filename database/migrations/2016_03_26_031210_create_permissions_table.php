...
class CreatePermissionsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('permissions')->insert([
            ...
            [ 'id' => 29, 'element' => 'measurement', 'action' => 'view', 'text' => 'Show Measurements' ],
            [ 'id' => 30, 'element' => 'measurement', 'action' => 'create', 'text' => 'Create New Measurement' ],
            [ 'id' => 31, 'element' => 'measurement', 'action' => 'update', 'text' => 'Edit Measurements' ],
            [ 'id' => 32, 'element' => 'measurement', 'action' => 'delete', 'text' => 'Delete Measurement' ],

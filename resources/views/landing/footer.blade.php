        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="footer-social social-btn m-t-md inverse">
                    ...
                    <a href="#" class="sb-instagram"><i class="fa fa-linkedin-square" style="color: rgb(255, 255, 255); font-size: 22px;" src="img/uploads/1463089390_easel.png" id="ui-id-1"></i></a>
                </div>
            </div>
            <!-- Footer Links -->
            <div class="col-md-2">

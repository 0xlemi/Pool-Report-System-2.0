          ...
          <tr>
            <td width="100%" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <div class="sortable_inner ui-sortable">
                  ...
                  <tr>
                    <td align="center" width="400" valign="middle"><!-- Header Text -->
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                        <tr>
                          <td valign="middle" width="100%" style="text-align: center;" class="fullCenter" ><a href="#" target="_blank" style="text-decoration:none;"><img class="em_logo mCS_img_loaded" src="https://s3.amazonaws.com/dev.poolreportsystem.com/images/assets/app/logo-black.png" alt="logo" width="300" height="35" border="0" style="text-align:center;" ></a></td>
                        </tr>
                      </table></td>
                  </tr>
                ...
                </table><div style="display: none;" id="element_044362174724781545"></div></p></div>
              </div></td>
          </tr>
        </table>
            ...
            <td align="center" width="100%" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                <tr>
                  <td align="center" width="100%" valign="middle" bgcolor="#ffffff" style="border-radius: 5px; background-color: rgb(255, 255, 255);"><div class="sortable_inner ui-sortable">
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small" style="position: relative; left: 0px; top: 0px;" class="">
                        <tr>
                          <td height="45" class="em_h40"><img src="{{ \Storage::url('images/assets/email/spacer.gif') }}" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table><table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small" style="position: relative; left: 0px; top: 0px;">
                        <tr>
                          <td align="center" width="250" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size: 30px; color: rgb(51, 51, 51); font-family: Lato, Arial, sans-serif; font-weight: 400; line-height: 34px;"  cu-identify="element_08244225362305473">You're pool company<div><div><span style="font-weight: bold;">West Side Pools</span></div></td>
                              </tr>
                            </table></td>
                        </tr>
                      </table><div style="display: none;" id="element_04742722409586768"></div></p></div><table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small" style="position: relative; left: 0px; top: 0px;">
                        <tr>
                          <td align="center" width="250" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size: 30px; color: rgb(51, 51, 51); font-family: Lato, Arial, sans-serif; font-weight: 400; line-height: 34px;"  cu-identify="element_06586646752801231"><multiline style="font-size: x-large;">is now using</td>
                              </tr>
                            </table></td>
                        </tr>
                      </table><table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small" style="position: relative; left: 0px; top: 0px;">
                        <tr>
                          <td align="center" width="250" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size: 30px; color: rgb(51, 51, 51); font-family: Lato, Arial, sans-serif; font-weight: 400; line-height: 34px;"  cu-identify="element_04333715011096744"><multiline style="font-size: x-large; font-weight: bold;">Pool Report System</td>
                              </tr>
                            </table></td>
                        </tr>
                      </table><div style="display: none;" id="element_05054191643155346"></div></p></div><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small" style="position: relative; left: 0px; top: 0px;" class="">
                        <tr>
                          <td height="45" class="em_h40"><img src="{{ \Storage::url('images/assets/email/spacer.gif') }}" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                        <tr>
                      ...
                      <div style="display: none;" id="element_06490488222644979"></div></p></div>
                      <table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small" style="position: relative; left: 0px; top: 0px;">
                        <tr>
                          <td align="center" width="250" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                      ...
                      </table><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small" style="position: relative; left: 0px; top: 0px;" class="">
                        <tr>
                          <td height="45" class="em_h40"><img src="{{ \Storage::url('images/assets/email/spacer.gif') }}" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table><div style="display: none;" id="element_05621060398881677"></div></p></div><table width="290" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                        <tr>
                          <td align="center" width="250" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size: 15px; color: rgb(64, 64, 64); font-family: Lato, Arial, sans-serif; font-weight: 400; line-height: 23px;"  cu-identify="element_040971921232180253">With Pool Report System you are going to be able to see a bunch of information about your pool, and how it's been taken care of.</td>
                              </tr>
                            </table></td>
                        </tr>
                      </table><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small" style="position: relative; left: 0px; top: 0px;" class="">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" align="center" class="em_wrapper" object="drag-module-small">
                        <tr>
                          <td width="100%" align="center"><table border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="mcenter" width="250px">
                              <tr>
                                <td width="100%" align="center"><!-- SORTABLE -->
                                <a href="{{ route('auth.activate', $token) }}" target="_blank" style="text-decoration:none;">
                                  <div class="sortable_inner ui-sortable">
                      ...
                      <!-- End Button -->
                      <div style="display: none;" id="element_05626117782157176"></div></p></div>
                      <div style="display: none;" id="element_05504775104887847"></div></p></div>
                      <table align="center" width="100" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td height="45" class="em_h40"><img src="{{ \Storage::url('images/assets/email/spacer.gif') }}" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
              ...
              <table align="center" class="full" width="400" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">
                <tr>
                  <td><div class="sortable_inner ui-sortable">
                      ...
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td valign="top" align="center" style="font-family:'Lato', Arial, sans-serif; font-weight:400; font-size:11px; color:#ffffff; line-height:22px;"target="_blank" style="color:#ffffff;"  >
                            Unsubscribe
                            </a></td>
                        </tr>
                      </table>

...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
 <tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" >
    <tr>
      <td bgcolor="#79c34e" align="center"style="background-color: rgb(68, 158, 228);"><!-- Mobile Wrapper -->
                  ...
                  <tr>
                    <td align="center" width="400" valign="middle"><!-- Header Text -->
                      ...
                      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                        <tr>
                          <td valign="middle" width="100%" style="text-align: center;" class="fullCenter" ><a href="#" target="_blank" style="text-decoration:none;"><img class="em_logo mCS_img_loaded" src="{{ $logo }}" alt="logo" width="200" height="50" border="0" style="text-align:center;" ></a></td>
                        </tr>
                      </table></td>
                  </tr>
                </table>
            ...
            <td align="center" width="100%" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="border-top-right-radius: 5px; border-top-left-radius: 5px;">
                <tr>
                  <td align="center" width="100%" valign="middle" bgcolor="#ffffff" style="border-radius: 5px; background-color: rgb(255, 255, 255);"><div class="sortable_inner ui-sortable">
                      ...
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td height="16" class="em_h20"><img src="http://rocketway.net/templatebuilder/templates/notify3/images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table>
                      <table width="340" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                        <tr>
                          <td align="center" width="100%" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size:25px; color:#161619; font-family: Arial, sans-serif; font-weight:700;"  cu-identify="element_07946309655494408">{{ $title }}<!--[if !mso]><!--></span><!--<![endif]--></td>
                              </tr>
                            </table></td>
                        </tr>
                      </table>
					  <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td height="25"><img src="http://rocketway.net/templatebuilder/templates/notify3/images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table>
					  <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td valign="top" align="center" ><img src="{{ $objectImage }}" width="128" height="128" alt="" style="max-width:218px;" border="0"  class="mCS_img_loaded"></td>
                        </tr>
                      </table>
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                      ...
                      <table width="300" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                        <tr>
                          <td align="center" width="100%" valign="middle" class="em_pad"><table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" align="center" style="font-size:18px; color:#a8a8a8; font-family:'Lato',Arial, sans-serif; font-weight:400;" >{!! $moreInfo !!}</td>
                              </tr>
                            </table></td>
                        </tr>
                      </table>
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td height="33" class="em_h30"><img src="http://rocketway.net/templatebuilder/templates/notify3/images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                        </tr>
                      </table>
                      <!-- Centered Button -->
                        ...
                        <tr>
                          <td width="100%" align="center"><table border="0" cellpadding="0" cellspacing="0" align="center" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="mcenter" width="250px">
                              <tr>
								...
								<a href="{{ $magicLink }}" target="_blank" style="text-decoration:none;">
                                  <div class="sortable_inner ui-sortable">
                                    <table border="0" cellpadding="0" cellspacing="0" class="mcenter">
                                      <tr>
                                        <td align="center" valign="middle" height="40" bgcolor="#79c34e" style="font-size: 14px; font-family: Lato, Arial, sans-serif; font-weight: 700; color: rgb(255, 255, 255); border-radius: 5px; background: rgb(68, 158, 228); padding-left: 20px; padding-right: 20px;" target="_blank" style="text-decoration:none; color:#ffffff; line-height:31px; display:block;" cu-identify="element_08931961103491808">GO AND TAKE A LOOK</td>
                                      </tr>
                                    </table>
                                  </div>
						  		</a>
                      ...
                      <table width="100" border="0" cellpadding="0" cellspacing="0" align="center" object="drag-module-small">
                        <tr>
                          <td align="center" width="100%" valign="middle"><table width="250" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                              <tr>
                                <td width="100%" height="40" class="em_h40"><img src="http://rocketway.net/templatebuilder/templates/notify3/images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
                              </tr>
                            </table></td>
                        </tr>
                      </table>
        ...
        <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="50" class="em_h40"><img src="http://rocketway.net/templatebuilder/templates/notify3/images/spacer.gif" width="1" alt="" height="1" border="0" style="display:block;" class="mCS_img_loaded"></td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
          <tr>
              ...
              <table align="center" class="full" width="400" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">
                <tr>
                  <td><div class="sortable_inner ui-sortable">
                      ...
                      <table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" object="drag-module-small">
                        <tr>
                          <td valign="top" align="center" style="font-family:'Lato', Arial, sans-serif; font-weight:400; font-size:11px; color:#ffffff; line-height:22px;"><a href="{{ $unsubscribeLink }}" target="_blank" style="text-decoration:none; color:#ffffff;"  >
                             Unsubscribe
                            </a></td>
                        </tr>
                      </table>

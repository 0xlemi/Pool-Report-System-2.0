					...
					<div class="card-block">
						<form method="POST" action="{{ url('clients/'.$client->seq_id) }}" enctype="multipart/form-data">
							...
							<div class="form-group row {{($errors->has('name'))? 'form-group-error':''}}">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control maxlength-simple"
											name="name" maxlength="50" value="{{ $client->name_extra }}">
							...
							<div class="form-group row {{($errors->has('last_name'))? 'form-group-error':''}}">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control maxlength-simple"
											name="last_name" maxlength="50" value="{{ $client->last_name_extra }}">
									<small class="text-muted">This is just the <strong>REFERENCE</strong> value</small>
							...
							<div class="form-group row {{($errors->has('email'))? 'form-group-error':''}}">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control maxlength-simple"
											name="email" maxlength="50" value="{{ $client->email_extra }}">
									<small class="text-muted">This is just the <strong>REFERENCE</strong> value</small>
									@if ($errors->has('email'))

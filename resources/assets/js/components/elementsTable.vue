...
export default Vue.extend({
	props: ['dataUrl', 'columns', 'highlightColumns'],
    components:{
    },
    data() {
        return {
			itemActions: [
                ...
                { name: 'edit-item', label: 'edit', icon: 'glyphicon glyphicon-zoom-in', class: 'btn btn-sm btn-warning' },
                { name: 'delete-item', label: 'delete', icon: 'glyphicon glyphicon-zoom-in', class: 'btn btn-sm btn-danger' },
            ],
